...
PARTS = [
    ...
    dict(ref="J1", lib="Connector:USB_C_Receptacle_USB2.0_16P", val="USB-C",
         ...
         mpn="TYPE-C-31-M-12", mfr="HRO", group="usb"),
    dict(ref="R1", lib="Device:R", val="5.1k", fp=R0805,
         mpn="RC0805FR-075K1L", mfr="Yageo", rating="1%, 1/8W", group="usb"),
    ...
    dict(ref="SW1", lib="Switch:SW_Push", val="RESET",
         ...
         mpn="PTS810 SJM 250 SMTR LFS", mfr="C&K", group="mcu"),
    ...
    dict(ref="D11", lib="Diode:1N4148W", val="1N4148W", fp=SOD123,
         mpn="1N4148W-7-F", mfr="Diodes Incorporated",
         rating="drops +5V_EXT to ~4.3V for D1", group="led"),
    dict(ref="C17", lib="Device:C", val="100nF", fp=C0805,
         mpn="CL21B104KBCNNNC", mfr="Samsung", rating="50V X7R", group="led"),
    dict(ref="R7", lib="Device:R", val="330R", fp=R0805,
         mpn="RC0805FR-07330RL", mfr="Yageo", rating="1%, 1/8W", group="led"),
    dict(ref="R20", lib="Device:R", val="10k", fp=R0805,
         mpn="RC0805FR-0710KL", mfr="Yageo", rating="1%, 1/8W", group="led"),
    ...
    dict(ref="R21", lib="Device:R", val="2.2k", fp=R0805,
         mpn="RC0805FR-072K2L", mfr="Yageo", rating="1%, 1/8W", group="led"),
    ...
    dict(ref="C9", lib="Device:C", val="100nF", fp=C0805,
         mpn="CL21B104KBCNNNC", mfr="Samsung", rating="50V X7R", group="sensor"),
    dict(ref="C13", lib="Device:C", val="10uF", fp=C0805,
         mpn="CL21A106KOQNNNE", mfr="Samsung", rating="16V X5R", group="sensor"),
    ...
    dict(ref="U6", lib="wisp:BH1750FVI-TR", val="BH1750FVI-TR",
         ...
         mpn="BH1750FVI-TR", mfr="ROHM", rating="lux, I2C 0x23", group="sensor"),
    ...
    dict(ref="U7", lib="Sensor:BME280", val="BME280",
         ...
         mpn="BME280", mfr="Bosch Sensortec",
    ...
    dict(ref="R8", lib="Device:R", val="4.7k", fp=R0805,
         mpn="RC0805FR-074K7L", mfr="Yageo", rating="1%, I2C pull-up",
         group="sensor"),
    ...
    dict(ref="R15", lib="Device:R", val="220R", fp=R0805,
         mpn="RC0805FR-07220RL", mfr="Yageo", rating="1%, ESD series",
         group="exp"),
    ...
    dict(ref="R14", lib="Device:R", val="4.7k", fp=R0805, dnp=True,
         mpn="RC0805FR-074K7L", mfr="Yageo", rating="1%, 1-Wire pull-up",
         group="exp"),
    ...
    dict(ref="C16", lib="Device:C", val="100nF", fp=C0805,
         mpn="CL21B104KBCNNNC", mfr="Samsung", rating="50V X7R, ADC filter",
         group="exp"),
